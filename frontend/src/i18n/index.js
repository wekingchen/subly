...
const zh = {
  ...
  creditCards: {
    ...
    repayTitle: '登记还款', repayAmountLabel: '本次还款金额', repayRemaining: '剩余待还 {amount}', repaidSoFar: '已还 {amount}', repayAmountPlaceholder: '最高 {amount}', repayAmountInvalid: '请输入有效金额（正数，最多两位小数）', repayAmountExceeds: '还款金额不能超过剩余待还 {amount}', repayConfirm: '确认还款', repayFailed: '还款登记失败，请重试', purgeRepayment: '清除还款记录', repayDoneCleared: '「{name}」的 {cycles} 已还清', repayDonePartial: '已登记还款 {amount}，「{name}」剩余待还 {remaining}', statementPartialTag: '已还 {paid} / 待还 {remaining}', unmarkRepaidConfirmTitle: '取消还款标记', unmarkRepaidConfirmMessage: '将同时清除该账单已登记的还款 {amount}，恢复为未还状态。确认继续？', outstandingRefreshFailed: '还款已登记，但待还汇总刷新失败——请下拉刷新查看最新剩余',
    ...
    annualFeeTitle: '免年费进度', annualFeeMet: '年费可豁免', annualFeeMetTag: '本周期刷免达标，年费可豁免', annualFeeCountProgress: '{n}/{total} 笔', annualFeeBarLabel: '免年费进度 {pct}%', annualFeeCharged: '检测到年费入账 {amount} 元（{cycle}账单），请核实银行是否已豁免', annualFeeMissing: '缺少 {n} 期账单数据（{cycles}），进度可能偏低', annualFeeSkipped: '{n} 期无消费已跳过（{cycles}），不计入进度', annualFeeLoadFailed: '免年费进度加载失败',
