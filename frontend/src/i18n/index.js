...
const zh = {
  ...
  creditCards: {
    ...
    annualFeeTitle: '免年费进度', annualFeeMet: '年费可豁免', annualFeeCountProgress: '{n}/{total} 笔', annualFeeBarLabel: '免年费进度 {pct}%', annualFeeCharged: '检测到年费入账 {amount} 元（{cycle}账单），请核实银行是否已豁免', annualFeeMissing: '缺少 {n} 期账单数据（{cycles}），进度可能偏低', annualFeeSkipped: '{n} 期无消费已跳过（{cycles}），不计入进度', annualFeeLoadFailed: '免年费进度加载失败',
