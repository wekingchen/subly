...
export const BANK_BRANDS = {
  cmb: { name: '招商银行', slug: 'cmbchina_com', short: '招', color: '#C8102E', logo: '', aliases: ['招商', '招商银行', '招行', '招商银行股份有限公司', 'cmb', 'china merchants'] },
  pab: { name: '平安银行', slug: 'pingan_com', short: '平', color: '#F58220', logo: '', aliases: ['平安', '平安银行', '平安银行股份有限公司', 'pab', 'ping an'] },
  cmbc: { name: '民生银行', slug: 'cmbc_com_cn', short: '民', color: '#0066B3', logo: '', aliases: ['民生', '民生银行', '中国民生银行', '民生银行股份有限公司', 'cmbc', 'minsheng'] },
  citic: { name: '中信银行', slug: 'citicbank_com', short: '中', color: '#C7000B', logo: '', aliases: ['中信', '中信银行', '中信银行股份有限公司', 'citic', 'china citic'] },
  ccb: { name: '建设银行', slug: 'ccb_com', short: '建', color: '#0A6DA4', logo: '', aliases: ['建设', '建设银行', '建行', '中国建设银行', 'ccb', 'china construction'] }
}
