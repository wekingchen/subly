...
const zh = {
  ...
  creditCards: {
    ...
    outstandingTitle: '待还款总额', outstandingHint: '{n} 期账单未标记还款', outstandingEmpty: '暂无待还款账单', outstandingOrphan: '含 {n} 期已删卡账单，重新添加同尾号卡并解析即可关联标记', outstandingLoadFailed: '加载失败',
    markRepaid: '标记已还款', markRepaidHint: '把这张卡 {n} 期未还账单一次标记为已还款', markRepaidTitle: '标记已还款', markRepaidMessage: '确认把「{name}」的 {n} 期账单（合计 {amount}）标记为已还款？标记后将从待还款总额中剔除。', markRepaidDone: '「{name}」已标记还款', markRepaidFailed: '标记失败，请重试', unmarkRepaid: '取消还款标记', repaidTag: '已还',
