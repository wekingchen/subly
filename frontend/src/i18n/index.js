...
const zh = {
  ...
  creditCards: {
    ...
    displayName: '卡片名称', bankName: '发卡银行', lastFour: '卡号后四位（可选）', statementDay: '账单日', dueDay: '计划还款日', remindDaysBefore: '提前提醒天数', monthDayHint: '填写每月 1–31 日；短月份由服务端按实际日期派生。', dueDayHint: '若早于账单日，表示下个月的计划还款日。', remindHint: '逗号分隔多个提醒点，如 7, 3, 1, 0（还款日当天）；留空表示不发送外部提醒，最多 8 项、每项 0–30。', lastFourPlaceholder: '留空则不记录尾号', lastFourHint: '仅用于展示辨识，Subly 不保存完整卡号。', remindPlaceholder: '7, 3, 1, 0', lastFourBatchHint: '可填多个尾号（如 1234,2234）一次创建多张卡，卡片名称会自动加上尾号区分。', creditLimit: '总额度（可选）', creditLimitPlaceholder: '如 50000', creditLimitHint: '授信上限仅作记录，可随时修改；不会出现在提醒或日历中。', creditLimitValue: '总额度 {n}', batchCreated: '已创建 {n} 张卡。', batchPartialFailed: '已创建 {n} 张，第 {m} 张失败：{reason}。',
